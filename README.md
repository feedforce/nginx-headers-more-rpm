...
エラー: ビルド依存性の失敗:
        gcc は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
        zlib-devel は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
        pcre-devel は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
        openssl-devel は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
$ sudo yum install -y gcc zlib-devel pcre-devel openssl-devel
$ rpmbuild -ba ~/rpmbuild/SPECS/nginx.spec
(省略)
書き込み完了: /home/vagrant/rpmbuild/SRPMS/nginx-1.7.10-ff1.el6.src.rpm
書き込み完了: /home/vagrant/rpmbuild/RPMS/x86_64/nginx-1.7.10-ff1.el6.x86_64.rpm
```
...
$ sudo yum update -y
$ sudo yum install -y rpm-build
$ curl -LO https://github.com/feedforce/nginx-headers-more-rpm/releases/download/1.7.10-ff1/nginx-1.7.10-ff1.el6.src.rpm
$ rpmbuild --rebuild nginx-1.7.10-ff1.el6.src.rpm
nginx-1.7.10-ff1.el6.src.rpm をインストール中です。
エラー: ビルド依存性の失敗:
        gcc は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
        zlib-devel は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
        pcre-devel は nginx-1.7.10-ff1.el6.x86_64 に必要とされています
